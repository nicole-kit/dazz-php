...
require_once 'connection.php';
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST")
    {
        if(isset($_POST['submit']))
        {
            ...
            $checkQuery = "SELECT * FROM users WHERE user_name = '$_POST[user_name]'";
            ...
            if(mysqli_num_rows($result) == 1)
            {
                ...
                {
                     $query = "DELETE FROM users WHERE user_name = '$_POST[user_name]' AND password = '$_POST[password]'";
                    echo "hello";
...
<form method="post">
   ...
   <div class="field-set">
      ...
      <!--   user name -->
        ...
        <!--   user name Input-->
         <input class="form-input" id="txt-input" type="text" placeholder="@UserName"  name="user_name">
